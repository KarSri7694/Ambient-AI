...
class RealTimeAudioInput:
    def __init__(
        ...
        skip_preprocessing_on_direct_transfer: bool = True,
    ):
        ...
        Args:
            ...
            skip_preprocessing_on_direct_transfer: Whether direct handoff requests preprocessing skip.
        """
        ...
        self.skip_preprocessing_on_direct_transfer = skip_preprocessing_on_direct_transfer
        self._can_enqueue_raw_audio = bool(
            self.audio_agent_service and hasattr(self.audio_agent_service, "enqueue_raw_audio")
        )
    ...
    def transfer_segment_to_audio_agent(self, skip_preprocessing: bool) -> bool:
        ...
        """
        if not self._can_enqueue_raw_audio:
            return False
    ...
    def start_recording(self):
        ...
        while True:
            ...
            try:
                ...
                transferred = self.transfer_segment_to_audio_agent(
                    skip_preprocessing=self.skip_preprocessing_on_direct_transfer
                )
                if transferred:
